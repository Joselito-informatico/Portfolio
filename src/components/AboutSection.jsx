...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="px-5 sm:px-8 md:px-16 lg:px-24 py-20 md:py-28 lg:py-36">
      ...
      >
        <span className="text-xs font-semibold tracking-[0.22em] uppercase clr-accent">04 — Sobre mí</span>
        ...
        >
          ...
          <motion.div variants={shouldReduce ? undefined : fadeUp}>
            ...
            >
              ...
              <span className="clr-accent">que resuelve</span><br />
              problemas reales.
            </h2>
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xs font-semibold tracking-[0.18em] uppercase clr-accent">Disponible ahora</span>
            </div>
            <div className="flex flex-wrap gap-2">
              {AVAILABILITY.map(({ label, icon }) => (
                <span
                  ...
                  style={{ border: '1px solid rgba(255,255,255,0.09)', backgroundColor: 'rgba(255,255,255,0.02)' }}
                >
                  <span className="clr-accent"><AvailabilityIcon type={icon} /></span>
                  {label}
                </span>
              ))}
            </div>
        ...
        >
          ...
          >
            ...
            <div className="flex items-start gap-4">
              <div
                className="font-display font-bold shrink-0 w-11 h-11 flex items-center justify-center text-base clr-accent"
                style={{ backgroundColor: 'rgba(0,255,136,0.1)', border: '1px solid rgba(0,255,136,0.2)' }}
              >
                3°
              </div>
              <div>
                <span className="text-xs font-semibold tracking-[0.18em] uppercase block mb-1 clr-accent">Logro destacado — 2025</span>
                <h3 className="font-display font-semibold text-base mb-1.5 clr-text">Rally Latinoamericano de Innovación</h3>
                <p className="text-sm leading-relaxed clr-muted">
                  Obtuve el 3er lugar en categoría Impacto Social, desarrollando una solución tecnológica
                  para problemas sociales complejos bajo condiciones de alta presión competitiva.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            style={{ backgroundColor: 'var(--color-surface)', border: '1px solid rgba(255,255,255,0.06)' }}
          >
            <h4 className="text-xs font-semibold tracking-[0.2em] uppercase mb-5 clr-muted">Certificaciones</h4>
            <ul className="flex flex-col">
              {CERTIFICATIONS.map((cert, i) => (
                ...
                >
                  ...
                  <span className="text-xs shrink-0 mt-0.5" style={{ color: 'rgba(255,255,255,0.25)' }}>{cert.date}</span>
                </li>
              ))}
            </ul>
          </motion.div>
