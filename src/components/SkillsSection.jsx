...
// Íconos SVG inline por tecnología — solo las principales
const ICONS = {
...
export default function SkillsSection() {
  ...
  return (
    ...
    >
      ...
      {/* Headline */}
      <motion.h2
        className="text-3xl sm:text-4xl md:text-5xl font-black leading-tight mb-16 max-w-xl"
            ...
            >
              {group.items.map((item) => (
                <motion.li
                  ...
                  className="group inline-flex items-center gap-2 px-3.5 py-2 text-sm font-medium cursor-default select-none transition-all duration-200"
                  style={{
