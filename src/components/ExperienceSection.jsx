        ...
        <div className="flex flex-col">
          {EXPERIENCE.map((item, i) => (
            ...
            >
              ...
              {/*
                Fix bug: el border-left verde como indicador de timeline en mobile.
                Se usa un wrapper con borde izquierdo fijo + la card interior sin borde izquierdo.
                Así evitamos que inline style sobreescriba el border shorthand en todos los breakpoints.
              */}
              <div
                className="md:hidden mb-[-1px]"
                style={{ borderLeft: '2px solid rgba(0,255,136,0.35)' }}
              >
                <div
              ...
              {/* Desktop: card normal sin border-left verde */}
              <div
                className="hidden md:block p-5 sm:p-6"
                style={{
                  backgroundColor: 'var(--color-surface)',
                  border: '1px solid rgba(255,255,255,0.06)',
                }}
...
function ExperienceCardContent({ item }) {
  return (
    <>
      {/* Header */}
